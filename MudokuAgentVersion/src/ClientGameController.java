...
public class ClientGameController extends GameController implements ActionListener 
{
	...
	public void init()			//Aqui comença l'execucio del Applet
	{
		...
		//Afegim els diferent elements al Applet i al SCREEN!
		ipField = new TextField(20);
		ipField.setSize(150,20);
		ipField.setLocation(50, 100);
		ipField.setText("127.0.0.1");			//IP del client o del servidor?
		add(ipField);

		portField = new TextField(4);
		portField.setSize(50,20);
		portField.setLocation(220, 100);
		portField.setText("4380");				//Port
		add(portField);

		connectButton = new Button("Connect");
		connectButton.setLocation(280, 100);
		connectButton.setSize(70,20);
	...
	public void actionPerformed(ActionEvent action) {
		...
		{
		case "connect":
			if(!ipField.equals("") && !portField.getText().equals(""))
			{
				try {
